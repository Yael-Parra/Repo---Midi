# Generated by Django 5.1.6 on 2025-03-03 06:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_alumno', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Academico.alumno', verbose_name='Alumno')),
            ],
        ),
        migrations.CreateModel(
            name='Curso',
            fields=[
                ...
                ('nombre_curso', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nombre del Curso')),
                ('id_colegio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Academico.colegio', verbose_name='Colegio')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_alumno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Academico.alumno', verbose_name='Alumno')),
            ],
        ),
        migrations.CreateModel(
            name='Sesion',
            fields=[
                ...
                ('id_alumno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Academico.alumno', verbose_name='Alumno')),
                ('id_curso', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Academico.curso', verbose_name='Curso')),
                ('id_terapeuta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Academico.terapeuta', verbose_name='Terapeuta')),
            ],
        ),
        migrations.CreateModel(
            name='Inscripcion',
